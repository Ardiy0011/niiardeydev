...
const About = () => {
  return (
    ...
    >
      ...
      <motion.div
        className="about-contact-links"
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.6, duration: 0.6 }}
      >
        <a className="about-phone" href="tel:0241934584">
          <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="18" height="18">
        ...
        <a className="about-whatsapp" href="https://wa.me/233241934584" target="_blank" rel="noreferrer">
          <svg className="contact-icon" viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
